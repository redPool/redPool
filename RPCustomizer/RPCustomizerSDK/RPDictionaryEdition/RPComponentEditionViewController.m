//
//  RPComponentEditionViewController.m
//  RedPool Demo App
//
...
@implementation RPComponentEditionViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == [self.keys count]) {
        ...
        if ([key isEqualToString:kItemName]) {
            ...
            RPColorPickerController *colorPickerController = [RPColorPickerController new];
            ...
            numberPickerController.key = key;
            numberPickerController.delegate = self;
            numberPickerController.textFieldType = RPTextFieldTypeFloat;
            [self.navigationController pushViewController:numberPickerController animated:YES];
        }
    }
}
